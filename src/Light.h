...
*	@file Light.h
*/
#ifndef INCLUDE_H_LIGHT
#define INCLUDE_H_LIGHT
...
public:
	...
	SpotLightActor(const std::string& name, const glm::vec3& c, const glm::vec3& p, const glm::vec3& d, float cutOff, float innerCutOff) :
